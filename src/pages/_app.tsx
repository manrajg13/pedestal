      ...
      <ClerkProvider
        appearance={{
          elements: { 
            ...
            card: "mt-40 bg-black-600 rounded-sm",
            headerTitle: "text-yellow-200",
            headerSubtitle: "text-white-100",
            formFieldLabel: "text-white-100",
            modalCloseButton: "mt-40 text-white-100 rounded-none hover:bg-yellow-200 hover:brightness-125 hover:text-black-500",
            ...
            formHeaderSubtitle: "tex t-white-100/75",
            otpCodeFieldInput: "text-white-100/50 border-yellow-200",
            socialButtons: "bg-black-600",
            socialButtonsBlockButton: "bg-white-100 hover:bg-white-100",
